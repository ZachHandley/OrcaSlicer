...
// RGB2HSV moved to the engine (src/libslic3r/FlushVolCalc.cpp) — its only
// consumer was engine-side, and keeping it here created an engine→GUI link
// dependency once libslic3r became a shared library.
